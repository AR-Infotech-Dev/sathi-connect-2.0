...
export function companySettingsToEnv(settings) {
  ...
  if (settings.saathiApplicabilityDate) env.SAATHI_APPLICABILITY_DATE = settings.saathiApplicabilityDate;
  ...
  if (settings.tallyGrnVoucherTypeName) env.TALLY_GRN_VOUCHER_TYPE_NAME = settings.tallyGrnVoucherTypeName;
  if (settings.tallyEntryType) env.TALLY_ENTRY_TYPE = settings.tallyEntryType;
...
export function pickCompanySettings(body) {
  const settings = {
    ...
    saathiApplicabilityDate: body.saathiApplicabilityDate,
    ...
    tallyGrnVoucherTypeName: body.tallyGrnVoucherTypeName,
    tallyEntryType: body.tallyEntryType,
